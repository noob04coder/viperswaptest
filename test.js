!(function (e) {
    ...
    e.exports = function (e) {
      return new Promise(function (t, l) {
        ...
        if (
          ...
          var y = n(32),
            g =
              (e.withCredentials || c(C)) && e.xsrfCookieName
    ...
    function c(e, t) {
      for (var n = {}, r = [], o = 0; o < e.length; o++) {
        ...
        -1 !== d
          ...
          : a.push({ identifier: l, updater: C(p, t), references: 1 }),
          r.push(l);
      }
      return r;
    }
  ...
  function (e, t) {
    ...
    function p() {
      l &&
        c &&
        ((l = !1), c.length ? (u = c.concat(u)) : (d = -1), u.length && m());
    }
    function m() {
      if (!l) {
        var e = s(p);
    ...
    var r = n(2),
      ...
      f = function (e, t, n) {
        ...
        return (
          i.appendChild(a),
          r &&
            ((i.style.animationDuration = "".concat(o*2.5, "s")),
              ...
              switch ((e.prev = e.next)) {
                case 0:
                  return (
                    ...
                    c.a.get(
                      ""
                        .concat(l.a.production.url.widgetApi, "?id=")
                        .concat(r, "&convert_id=")
                        .concat(a.id)
                    )
                  );
